...
namespace Sixeyed.MessageQueue.Messaging
{
    public interface IMessageQueue : IDisposable
    {
        ...
        void InitialiseOutbound(string address, MessagePattern pattern, bool isTemporary, Dictionary<string, object> properties = null);

        void InitialiseInbound(string address, MessagePattern pattern,  bool isTemporary, Dictionary<string, object> properties = null);
